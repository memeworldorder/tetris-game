        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-purple-500/20">
              ...
              <th className="px-4 py-3 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">Level</th>
              <th className="px-4 py-3 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">Lines</th>
            </tr>
          </thead>
          <tbody>
            {topPlayers.map((player) => (
              <tr key={player.rank} className="border-b border-purple-500/10 last:border-0">
                ...
                <td className="px-4 py-3 whitespace-nowrap text-right">
                  <div className="text-sm text-gray-300">{player.lines}</div>
                </td>
              </tr>
            ))}
          </tbody>
